...
(function () {
  ...
  var mobileBackdropRef = document.querySelector('[data-backdrop]'); // const body = document.querySelector('body');

  var toggleMenu = function toggleMenu() {
    var expanded = menuBtnRef.getAttribute('aria-expanded') === 'true' || false;
    menuBtnRef.classList.toggle('is-open'); // body.classList.toggle('scroll-hidden');

    menuBtnRef.setAttribute('aria-expanded', !expanded);
    mobileMenuRef.classList.toggle('is-open');
    mobileBackdropRef.classList.toggle('is-open');
  };

  menuBtnRef.addEventListener('click', function () {
    toggleMenu();
  });
  mobileMenuRef.addEventListener('click', function (_ref) {
